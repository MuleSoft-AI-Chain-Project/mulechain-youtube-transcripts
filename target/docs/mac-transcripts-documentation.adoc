:toc:               left
:toc-title:         MAC Transcripts Module
:toclevels:         2
:last-update-label!:
:docinfo:
...
= MAC Transcripts Module Documentation Reference
...
[[Fetch-transcript]]
=== Fetch Transcript
`<mac-transcripts:fetch-transcript>`
...
=== Translate Transcript
`<mac-transcripts:translate-transcript>`
